class Account::CurrencyConverter
  ...
  attribute :convert_balance, :boolean, default: true
  ...
  def call
    ...
    ActiveRecord::Base.transaction do
      ...
      # Convert account balance and cash balance (only if convert_balance is true)
      convert_account_balances(exchange_rate) if convert_balance
